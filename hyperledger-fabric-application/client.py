...
def run():
    with grpc.insecure_channel('localhost:50051') as channel:
        ...
        ticket_id = "ticket7"  # Replace with the desired ticket ID
        ...
        ticket_id_to_transfer = "ticket6"  # Replace with the ticket ID to transfer
        ...
        try:
            ...
            read_ticket2 = Ticket_pb2.ReadTicketByIdRequest(ticketId="ticket6")
